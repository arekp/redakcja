...
<form name="presidentsForm" action="<s:url value="/importy/zarzadca_find.action"/>" >
    ...
    <jmesa:htmlTable>
        <jmesa:htmlRow>
            ...
            <jmesa:htmlColumn  title="Dodaj do klientów" >
                <a href="<s:url value="/importy/zarzadca_add.action?id="/>${bean.id}">Dodaj do klientów</a>
            </jmesa:htmlColumn>
        </jmesa:htmlRow>
    </jmesa:htmlTable>
    </jmesa:struts2TableFacade>
